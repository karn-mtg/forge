...
contextBridge.exposeInMainWorld('libraryAPI', {
  ...
  getCardTags:              (args) => ipcRenderer.invoke('lib:getCardTags', args),
  getDeckTags:              (args) => ipcRenderer.invoke('lib:getDeckTags', args),
  getDeckTagColors:         (args) => ipcRenderer.invoke('lib:getDeckTagColors', args),
  setTagColor:              (args) => ipcRenderer.invoke('lib:setTagColor', args),
  setCardTagAt:             (args) => ipcRenderer.invoke('lib:setCardTagAt', args),
  clearCardTagAt:           (args) => ipcRenderer.invoke('lib:clearCardTagAt', args),
  setCardTags:              (args) => ipcRenderer.invoke('lib:setCardTags', args),
  renameTagInDeck:          (args) => ipcRenderer.invoke('lib:renameTagInDeck', args),
  deleteTagFromDeck:        (args) => ipcRenderer.invoke('lib:deleteTagFromDeck', args),
  setArrangementGroupingLevel: (args) => ipcRenderer.invoke('lib:setArrangementGroupingLevel', args),
  getBranches:              (args) => ipcRenderer.invoke('lib:getBranches', args),
  createBranch:             (args) => ipcRenderer.invoke('lib:createBranch', args),
  renameBranch:             (args) => ipcRenderer.invoke('lib:renameBranch', args),
  deleteBranch:             (args) => ipcRenderer.invoke('lib:deleteBranch', args),
  getVersions:              (args) => ipcRenderer.invoke('lib:getVersions', args),
  releaseVersion:           (args) => ipcRenderer.invoke('lib:releaseVersion', args),
  getVersionDiff:           (args) => ipcRenderer.invoke('lib:getVersionDiff', args),
  isDeckDirty:              (args) => ipcRenderer.invoke('lib:isDeckDirty', args),
  switchBranch:             (args) => ipcRenderer.invoke('lib:switchBranch', args),
  restoreVersion:           (args) => ipcRenderer.invoke('lib:restoreVersion', args),
});
